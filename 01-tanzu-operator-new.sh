...
aws cloudformation delete-stack --stack-name tanzu-operator-stack --region $aws_region_code 

aws cloudformation create-stack --stack-name tanzu-operator-stack --region $aws_region_code \
...
aws cloudformation describe-stacks --stack-name tanzu-operator-stack --region $aws_region_code \
